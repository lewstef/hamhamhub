...
function parseCourseFormData(formData: FormData): { data: ParsedCourseData } | { error: string } {
  ...
  const acceptedDogWeight = (formData.get("acceptedDogWeight") as string) || null;
...
export async function createCourseAction(prevState: unknown, formData: FormData) {
  ...
  try {
    ...
    await db.insert(courses).values({
      ...
      plantWatering: d.plantWatering,
      plantWateringDetails: d.plantWatering ? d.plantWateringDetails : null,
      nonSmoker: d.nonSmoker,
      ...
      acceptedDogWeight: d.acceptedDogWeight,
