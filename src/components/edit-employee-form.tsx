...
import { updateEmployeeAction, changeEmployeePasswordAction } from "@/app/actions/employees";
...
export function EditEmployeeForm({ employee }: EditEmployeeFormProps) {
  ...
  const [generalState, generalAction, generalPending] = useActionState(updateEmployeeAction, null);
  const [passwordState, passwordAction, passwordPending] = useActionState(changeEmployeePasswordAction, null);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Modify credentials and permissions for {employee.username}.
        </p>
      </div>
        ...
        <Card className="max-w-xl">
          <CardHeader className="px-6 py-5 border-b border-border">
            ...
            <CardDescription className="text-xs">
              Submit modifications to the employee profile.
            </CardDescription>
          </CardHeader>
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <Input id="name" name="name" type="text" defaultValue={employee.name} required disabled={isPending} />
                </div>
                <div className="space-y-1.5">
                  <Label htmlFor="username" className="text-xs font-bold uppercase tracking-wider">Username</Label>
                  <Input id="username" name="username" type="text" defaultValue={employee.username || ""} required disabled={isPending} />
                </div>
                <div className="space-y-1.5">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-border mt-6">
                <Link href="/backoffice/employees" className={buttonVariants({ variant: "outline" })}>
                    Cancel
                  </Link>
      ...
      {activeTab === "password" && (
        <Card className="max-w-xl">
          <CardHeader className="px-6 py-5 border-b border-border">
            ...
            <CardDescription className="text-xs">
              Assign a new login password for the staff account.
            </CardDescription>
          </CardHeader>
